<template>
    <div class="auth">
        ...
        <ForgotPassword v-else-if="ifForgotPassword" />
        <Login v-else/>
    </div>
</template>
...
<script>
    ...
    import Login from '@/components/StartedComponents/LoginComponent.vue'
    import Register from '@/components/StartedComponents/RegisterComponent.vue'
    import ForgotPassword from '@/components/StartedComponents/ForgotPasswordComponent.vue'
    ...
    export default {
        ...
        computed: {
            isRegister () {
                return this.$route.path.match('register')
            },
            ifForgotPassword () {
                return this.$route.path.match('resetpassword')
            }

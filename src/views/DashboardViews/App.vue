        ...
        <div id="dashboardNav">
            <md-toolbar class="md-primary">
                <div class="md-toolbar-row">
                    ...
                    <md-tabs md-sync-route md-alignment="right" class="md-primary">
                        <md-tab id="tab-dashboard" md-label="Dashboard" :to="{'name': 'dashboard'}"></md-tab>
                        <md-tab id="tab-editor" md-label="Bot Editor" :to="{'name': 'botEditor'}"></md-tab>
                        <md-tab id="tab-analytics" md-label="Analytics" :to="{'name': 'analytics'}"></md-tab>
                        <md-tab id="tab-buy" md-label="Buy" :to="{'name': 'buy'}"></md-tab>
                        <md-tab id="tab-notifications" md-icon="notifications" :to="{'name': 'notifications'}"></md-tab>
                        <md-tab id="tab-profile" md-label="Profile" :to="{'name': 'admin'}"></md-tab>
                    </md-tabs>
                    </div>
                </div>
            </md-toolbar>
